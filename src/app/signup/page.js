        ...
        <div>
          <form className="flex flex-col gap-3 mt-4" onSubmit={handleSubmit}>
            <div className="flex gap-2 items-center border-2 border-gray-300 px-3 py-2 rounded-md focus-within:border-fuchsia-700 w-[90%] mx-auto">
              <LuUser className="text-fuchsia-700"/>
              <input
                type="text"
            ...
            <div className="w-[90%] mx-auto flex gap-4 items-center">
              <div>
              <input type="radio" name="role" id="user" value='user' checked={formData.role === 'user'} onChange={handleChange} />User
              </div>
                <div>
                <input type="radio" name="role" id="admin" value='admin' checked={formData.role === 'admin'}  onChange={handleChange}/>Admin
                </div>
            </div>
            ...
            <p className="text-center mt-3">Already have an account? <span className="text-fuchsia-800 font-semibold cursor-pointer" onClick={()=>router.push('/login')}>Login</span></p>
          </form>
        </div>
      </div>
      <Toaster/>
